...
def search_venues():
    ...
    search_response = venue.search_venue(search)

    return render_template('pages/search_venues.html', results=search_response)
...
def show_venue(venue_id):
    ...
    show_venue_data = venue.show_venue(venue_id, format_datetime)
...
def search_artists():
    ...
    artist_search_response = artist.search_artist(artist_search_term)

    return render_template('pages/search_artists.html', results=artist_search_response)
...
def show_artist(artist_id):
    ...
    show_artist_data = artist.show_artist(artist_id, format_datetime)
